...
public class Editor extends JFrame {	
	...
	private void handlePress(Point p) {
		if(mode == Mode.DRAW) {
			...
			int id = sketch.containsId((int) p.getX(), (int) p.getY());
			curr = sketch.getListOfShapes().get(id);
			if(curr != null && curr.contains((int) p.getX(), (int) p.getY())) {
				movingId = id;
				moveFrom = p;
			}
		}
